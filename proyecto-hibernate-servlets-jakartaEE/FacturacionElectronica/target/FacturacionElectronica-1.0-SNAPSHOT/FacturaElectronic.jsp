...
<html>
    <head>
        ...
        <title>Creacion de Factura Electronica</title>
    </head>
    <body>
    
    <% 
    // captura de datos del cliente, segun la id especificada, para vovoler a mostrarlo en los campos   
  ...
  <script src="js/crear_factura.js"></script>
    ...
    <% 
        //captura de datos sobre la factura digitada, para que no se pierdan y mostrarlos o volver a utilizarlos mas adelante
    ...
    <div class="form2">
    <input type="text" id="" class="filainput1" name="idFactura" value="<%=idFactura%>" disabled>     
    ...
    <input name="idFctr" type="hidden" value="<%=idFactura%>"/>
    ...
    <button id="buttonItem" class="button"> Agregar Item</button><br>
    </form>
    
    <hr id="barra1" width="100%" size="5">
    <% //obtencion del calculo de impuestos y valor total, para mostrarlo en los input
    ...
    <!<!-- se guarda en un tipo hidden por que necesitamos capturar este valor para editar en la base de datos -->
    <input name="idFactura" type="hidden" value="<%=idFactura%>"/>
    </div>
    <button  id="buttonGuardar" class="button">Generar</button><br>
    </form>
